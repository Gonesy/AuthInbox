...
('Generic verification code',1,'["verification code","security code","authentication code","verify code","one-time code","one time code","OTP","passcode"]','(?<![A-Za-z0-9])(?=[A-Za-z0-9]{4,8}(?![A-Za-z0-9]))(?=[A-Za-z0-9]*[0-9])[A-Za-z0-9]+(?![A-Za-z0-9])','Common English verification and OTP wording. Requires at least one digit.',100),
